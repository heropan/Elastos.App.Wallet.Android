		...
		jstring jremark)
{
    ...
    try {
        tx = wallet->CreateDepositTransaction(fromAddress, toAddress, amount, std::string(sidechainAccounts),
				std::string(sidechainAmounts), std::string(sidechainIndexs), memo, remark);
